...
import { ShoppingBag, CheckCircle2, XCircle, RefreshCw, Loader2, Link2, Unlink, Package, ExternalLink, Search } from "lucide-react";
          ...
          {productsLoading ? (
            ...
            <div className="p-10 text-center">
              ...
              <p className="text-sm text-muted-foreground">
                {products.length === 0 ? "No products found. Run a sync to load your catalog." : "No products match your search."}
              </p>
            </div>
          ) : (
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-6">
