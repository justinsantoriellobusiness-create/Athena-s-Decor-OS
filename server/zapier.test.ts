...
describe("Zapier Integration", () => {
  // These validate credential *format* only when the deployment secrets are
  // actually present. Asserting they exist fails any environment without them
  // (CI, fresh clones, local dev) — same pattern as the Wix test below.
